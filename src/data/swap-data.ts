...
export const mockSwapItems: SwapItem[] = [
  {
    ...
    description:
      'Iconic split-toe leather ankle boots in immaculate condition. Worn twice for editorial shoot.',
  },
  {
    id: 'item-2',
    ...
    description:
      'Heavyweight organic denim jacket with signature distressing and custom hardware.',
  },
  {
    id: 'item-3',
    ...
    description:
      'Structured mini top handle bag in smooth beige calfskin with gold metal plaque.',
  },
  {
    id: 'item-4',
    ...
    description:
      'Signature technical heat-pleated pants in deep navy. Wrinkle-resistant and incredibly fluid.',
  },
  {
    id: 'item-5',
    ...
    description:
      'Upcycled ocean-plastic nylon bomber jacket with enamelled triangle logo and utility pockets.',
  },
  {
    id: 'item-6',
    ...
    description:
      'Canvas high-top trainers with contrast bumper caps and elongated tongue. Authentic patina.',
  },
  {
    id: 'item-7',
    ...
    description:
      'Second-skin jersey top featuring all-over iconic crescent moon motif in tan and black.',
  },
];
